...
def send_delivery_confirmation_email(recipient_email, recipient_name, order_number, recipient_type='customer'):
    """
    Send delivery confirmation email to customer or seller
    
    Args:
        recipient_email: Email address
        recipient_name: Name of recipient
        order_number: Order number
        recipient_type: 'customer' or 'seller'
    """
    if recipient_type == 'customer':
        subject = f"✅ Order Delivered - {order_number}"
        message = f"Your order {order_number} has been successfully delivered!"
    else:  # seller
        subject = f"📦 Order Delivered - {order_number}"
        message = f"Order {order_number} has been successfully delivered to the customer."
